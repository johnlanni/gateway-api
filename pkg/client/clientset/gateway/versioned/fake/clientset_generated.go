...
import (
	...
	clientset "sigs.k8s.io/gateway-api/pkg/client/clientset/gateway/versioned"
	gatewayv1alpha2 "sigs.k8s.io/gateway-api/pkg/client/clientset/gateway/versioned/typed/apis/v1alpha2"
	fakegatewayv1alpha2 "sigs.k8s.io/gateway-api/pkg/client/clientset/gateway/versioned/typed/apis/v1alpha2/fake"
	gatewayv1beta1 "sigs.k8s.io/gateway-api/pkg/client/clientset/gateway/versioned/typed/apis/v1beta1"
	fakegatewayv1beta1 "sigs.k8s.io/gateway-api/pkg/client/clientset/gateway/versioned/typed/apis/v1beta1/fake"
)
